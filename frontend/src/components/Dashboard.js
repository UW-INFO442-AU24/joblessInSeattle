        ...
        <Col className='m-4' >
            ...
            <Row className='m-4'>
                <Card className='bg-primary bg-opacity-75 text-white'>
                  <Card.Body><Link to="/watertracker" className="stretched-link"></Link>
            ...
            <Row className='m-4'>
                <Card className='bg-info bg-opacity-50 text-black-50'>
                  <Card.Body><Link to="/sleeptracker" className="stretched-link"></Link>
                    <div className='d-flex flex-row justify-content-between'>
                        <div>
            ...
            <Row className='m-4'>
                <Card className='bg-success bg-opacity-75 text-white'>
                  <Card.Body><Link to="/medications" className="stretched-link"></Link>
                    <div className='d-flex flex-row justify-content-between'>
                      <div>
            ...
            <Row className='m-4'>
                <Card className='bg-warning bg-opacity-75 text-black-50'>
                  <Card.Body><Link to="/buddy" className="stretched-link"></Link>
                    <div className='d-flex flex-row justify-content-between'>
                      <div>
